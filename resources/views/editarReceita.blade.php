<x-layouts::app :title="__('Editar Receita')">
    <div class="flex h-full w-full flex-1 flex-col gap-6 rounded-xl max-w-xl">
        ...
        <div>
            ...
            <p class="text-sm text-neutral-500 dark:text-neutral-400">
                Altere os dados permitidos da receita
            </p>
        </div>
        ...
        @if ($errors->any())
            ...
            >
                <div class="flex items-center gap-2 font-medium">
                    ...
                    <span>Não foi possível atualizar a receita</span>
                </div>
        ...
        <form
            method="POST"
            action="{{ route('receitas.update', $receita) }}"
            ...
            <div class="flex flex-col gap-1">
                ...
                >
                    ...
                    @foreach ($contas as $conta)
                        <option 
                            value="{{ $conta->id }}"
                            {{ old('conta_id', $receita->conta_id) == $conta->id ? 'selected' : '' }}
                        >
                            {{ $conta->nome }} 
